			...
			<head>
				<xsl:choose>
					<xsl:when test="kml:kml">
						<title>Locations Sitemap - Azka Kitchen Set</title>
					</xsl:when>
					<xsl:otherwise>
						<title>XML Sitemap - Azka Kitchen Set</title>
					</xsl:otherwise>
				</xsl:choose>
				...
				<xsl:choose>
					<xsl:when test="kml:kml">
						...
						<div id="content">
							...
							<p class="expl">
								<a href="https://flourishing-leopard-6eee8f.instawp.site/sitemap_index.xml">&#8592; Sitemap Index</a>							</p>
